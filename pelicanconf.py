...
# Profile information
NAME = 'Сітала Микола'
TAGLINE = 'Директор/Керівник відділу'
PIC = 'profile.png'
...
CAREER_SUMMARY = 'Фахівець у галузі логістики та обробки даних Python. Маю хороші аналітичні здібності та ' \
                 'досвід створення унікальних рішень у  логістиці, створення бізнес вимог, оцінка вартості ' \
                 'володіння сховища даних. Швидко навчаюсь, прагну стати частиною професійної команди, в якій я міг би ' \
                 'застосувати свої навички та досвід для досягнення командних результатів.'
